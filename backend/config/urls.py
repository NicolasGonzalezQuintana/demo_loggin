...
from academics.views import student_dashboard, teacher_dashboard, teacher_create_announcement, teacher_enrollments
...
urlpatterns = [
    ...
    path("api/teacher/enrollments/", teacher_enrollments),
